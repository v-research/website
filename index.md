...
<div class="row">
    ...
    <p class="eng-text-m">
 	    As engineers we don't like to use a natural language to describe v-research. Hopefully, you'll enjoy our slight abuse of notation in <a href="" target="blank">this</a> UML deployment diagram.
    </p>
    <p class="eng-text-d">
